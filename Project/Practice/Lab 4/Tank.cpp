...
void Tank::Draw(Shader& shader, Camera& camera, glm::vec3 translation, glm::quat rotation, glm::vec3 scale)
{
...
void Tank::loadMesh(unsigned int indMesh)
{
...
void Tank::traverseNode(unsigned int nextNode, glm::mat4 matrix)
{
...
std::vector<unsigned char> Tank::getData()
{
...
std::vector<float> Tank::getFloats(json accessor)
{
...
std::vector<GLuint> Tank::getIndices(json accessor)
{
...
std::vector<Texture> Tank::getTextures()
{
...
std::vector<Vertex> Tank::assembleVertices
(
...
std::vector<glm::vec2> Tank::groupFloatsVec2(std::vector<float> floatVec)
{
...
std::vector<glm::vec3> Tank::groupFloatsVec3(std::vector<float> floatVec)
{
...
std::vector<glm::vec4> Tank::groupFloatsVec4(std::vector<float> floatVec)
{
